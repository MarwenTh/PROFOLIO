...
export const Hero = () => {
  ...
  return (
    <section
      ref={targetRef}
      className="h-screen w-full bg-white dark:bg-neutral-950 relative flex flex-col items-center justify-center overflow-hidden antialiased transition-colors duration-300"
    >
      {/* Aurora Background */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-white/90 dark:bg-neutral-950/90" />{" "}
        {/* Dimmer */}
      </div>
      ...
      >
        ...
        >
          The ultimate portfolio builder for modern creatives. Stand out with
          stunning, motion-rich templates designed to convert.
        </motion.p>
