...
export const ContextMenu = () => {
    const { contextMenu, closeContextMenu, setElementAsBackground, removeComponent, updateComponent, sections } = useEditor();
    ...
    const targetComponent = sections.flatMap(s => s.components).find(c => c.id === contextMenu.componentId);
    ...
    const menuItems = [
        ...
        { 
            ...
            icon: MoveUp, 
            onClick: () => {
                if (contextMenu.componentId) updateComponent(contextMenu.componentId, { zIndex: 100 });
                closeContextMenu();
            },
        ...
        { 
            ...
            icon: MoveDown, 
            onClick: () => {
                if (contextMenu.componentId) updateComponent(contextMenu.componentId, { zIndex: 0 });
                closeContextMenu();
            },
            show: !!contextMenu.componentId
        },
