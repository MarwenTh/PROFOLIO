...
const sidebarLinks = [
  ...
  { name: "Studio", href: "/dashboard/studio", icon: Code2, category: "Tools" },
    ...
    >
                      ...
                      <Link
                        ...
                        onMouseEnter={(e) => {
                          if (isCollapsed) {
                            ...
                            }); // Center tooltip (approx 32px height)
                          }
                        }}
      ...
      <div className="p-6 border-t border-neutral-200 dark:border-white/5 bg-neutral-50 dark:bg-neutral-900/50 backdrop-blur-md shrink-0 space-y-4">
        ...
        >
          <button
            ...
            className={cn(
              ...
              isCollapsed
                ...
                : "bg-white dark:bg-neutral-800/50 border border-neutral-200/50 dark:border-white/5",
            )}
          >
          ...
          <div className={cn("shrink-0", isCollapsed && "mt-2")}>
            <ModeToggle />
          </div>
        </div>
      </div>
        ...
        {isCollapsed && hoveredItem && (
          ...
          >
            <div className="flex items-center">
              {/* Tooltip Arrow */}
              <div
                className="w-2 h-4 bg-neutral-900 dark:bg-white clip-arrow transform -translate-x-1"
