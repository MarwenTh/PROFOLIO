...
const SectionHeader = ({ children, collapsible, isOpen, onToggle }) => (
  <Flex
    ...
    opacity={0.8}
  >
    <Text fontSize="11px" color="rgba(255, 255, 255, 0.4)" fontWeight={800} textTransform="uppercase" letterSpacing="0.1em">
      {children}
    </Text>
    {collapsible && <Icon as={isOpen ? ChevronUp : ChevronDown} boxSize={3.5} color="rgba(255, 255, 255, 0.3)" />}
  </Flex>
);
  ...
  <Box my={4}>
    ...
    <Slider.Root value={[value]} onValueChange={({ value: v }) => onChange(v[0])} min={min} max={max} step={step}>
      <Slider.Control>
        ...
        <Slider.Thumb index={0} boxSize={3} bg="#fff" borderRadius="full" boxShadow="0 0 15px rgba(82, 39, 255, 0.4)" border="2px solid #5227FF" cursor="pointer" />
      </Slider.Control>
    </Slider.Root>
  </Box>
);
...
const ToggleButton = ({ icon: IconComponent, label, isActive, onClick, disabled, flex }) => (
  ...
  >
    <Icon as={IconComponent} boxSize={3.5} color={isActive ? '#5227FF' : 'rgba(255, 255, 255, 0.4)'} flexShrink={0} />
    {label && (
      <Text fontSize="11px" fontWeight={700} color={isActive ? '#5227FF' : 'rgba(255, 255, 255, 0.4)'} whiteSpace="nowrap">
        {label}
      </Text>
    )}
  </Flex>
...
const SelectInput = ({ label, value, onChange, options, width = '100%' }) => {
  return (
    <Box my={6}>
      <Text fontSize="12px" fontWeight={600} color="rgba(255, 255, 255, 0.5)" textTransform="uppercase" letterSpacing="0.05em" mb={3}>
        {label}
      </Text>
      <Flex wrap="wrap" gap={2}>
        {options.map(opt => (
          <Box
            ...
            py={2.5}
            borderRadius="12px"
            bg={value === opt.value ? 'rgba(82, 39, 255, 0.15)' : 'rgba(255, 255, 255, 0.03)'}
            border="1px solid"
            borderColor={value === opt.value ? '#5227FF' : 'rgba(255, 255, 255, 0.08)'}
            transition="all 0.2s cubic-bezier(0.4, 0, 0.2, 1)"
            _hover={{ 
              bg: value === opt.value ? 'rgba(82, 39, 255, 0.2)' : 'rgba(255, 255, 255, 0.06)',
              borderColor: value === opt.value ? '#5227FF' : 'rgba(255, 255, 255, 0.15)'
            }}
            ...
            textAlign="center"
          >
            <Text fontSize="11px" fontWeight={700} color={value === opt.value ? '#fff' : 'rgba(255, 255, 255, 0.4)'}>
              {opt.label}
            </Text>
          </Box>
        ))}
...
const SwitchInput = ({ label, checked, onChange }) => (
  <Flex align="center" justify="space-between" w="100%" my={4}>
    <Text fontSize="12px" fontWeight={600} color="rgba(255, 255, 255, 0.5)" textTransform="uppercase" letterSpacing="0.05em">
      {label}
    </Text>
...
export const AddEffectPanel = ({ onAddEffect }) => {
  ...
  return (
    <Flex direction="column" h="100%" minH={0}>
      ...
      >
        ...
        {showAddEffect && <AddEffectPanel onAddEffect={handleAddEffect} />}
      ...
      <Box pt={4}>
        <Flex gap={2} mb={3}>
          ...
          >
            <Icon as={FileUp} boxSize={3.5} color="rgba(255, 255, 255, 0.4)" />
        ...
        <Flex gap={3} mb={3} mt={4}>
          {mediaType !== 'video' && (
            <Flex
              ...
              opacity={corsError || !image ? 0.3 : 1}
              onClick={corsError || !image ? undefined : onCopyToClipboard}
              transition="all 0.3s"
              _hover={{ bg: 'rgba(255, 255, 255, 0.06)', borderColor: 'rgba(255, 255, 255, 0.15)' }}
            >
              <Icon as={Copy} boxSize={3.5} color="rgba(255, 255, 255, 0.4)" />
              <Text fontSize="12px" color="rgba(255, 255, 255, 0.6)" fontWeight={600}>
                Copy
              </Text>
            </Flex>
        ...
        <Flex
          ...
          _hover={{ bg: corsError || (!image && !video) || isExporting ? '#5227FF' : '#6B3FFF', transform: 'translateY(-2px)', boxShadow: '0 12px 40px rgba(82, 39, 255, 0.5)' }}
        ...
        >
          ...
          >
            <Flex align="center" gap={2.5}>
              ...
              >
                <Icon as={isExporting ? RotateCcw : Download} boxSize={4.5} color="#fff" />
              </Box>
