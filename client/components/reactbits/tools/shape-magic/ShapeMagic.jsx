...
import Controls, { ShapeToolbox } from './Controls';
...
export default function ShapeMagic({ toolSelector }) {
  ...
  return (
    ...
    >
      ...
      {/* 3. Left Floating Sidebar (Toolbox) */}
      <Box
        position="absolute"
        top="88px"
        left={6}
        ...
        <Flex direction="column" h="100%">
          ...
          <Box flex={1} overflowY="auto" p={6} className="custom-scrollbar">
            <ShapeToolbox 
              ...
              hasThreeOrMoreSelected={selectedIds.length >= 3}
            />
          </Box>
        </Flex>
      </Box>
