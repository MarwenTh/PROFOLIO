...
import { MoveLeft, Loader2, LogIn, ArrowRight, X, Mail } from "lucide-react";
      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black transition-colors duration-300 relative">
        ...
        >
          ...
          >
            ...
            <Link
              href="/signup"
              className="text-neutral-900 dark:text-white hover:underline underline-offset-4 font-medium"
            >
              Sign up
            </Link>
          </motion.div>
