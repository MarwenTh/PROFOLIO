          ...
          {portfolios
            ...
            .map((p, i) => (
              <DashboardCard key={p.id} className="group">
                ...
                <h3 className="text-xl font-black italic tracking-tighter mb-1">
                  {p.title}
                </h3>
                <p className="text-xs text-neutral-500 mb-8 font-medium italic">
                  profolio.pro/p/{p.slug}
                </p>
