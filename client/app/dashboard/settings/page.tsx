          ...
          <AnimatePresence mode="wait">
            {activeTab === "profile" && (
              ...
              >
                <DashboardSection
                  ...
                  description="Update your public profile and how people see you."
                >
                  <DashboardCard>
                    <div className="flex flex-col md:flex-row items-start gap-10">
                      <div className="relative group cursor-pointer shrink-0">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-center mt-3 text-neutral-400">
                          Change Photo
                        </p>
                      </div>
                  ...
                  <DashboardCard>
                    <div className="max-w-md space-y-6">
                      ...
                      <div className="flex items-center gap-2 px-1">
                        ...
                        <label
                          htmlFor="show"
                          className="text-[10px] font-black uppercase tracking-widest text-neutral-500 cursor-pointer"
                        >
                          Show Passwords
                        </label>
                      </div>
                ...
                >
                  <DashboardCard className="border-red-500/20 bg-red-500/5 backdrop-blur-sm">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                      <div>
                        <h4 className="text-lg font-black text-red-500 italic tracking-tight">
                          Delete Account
                        </h4>
                        <p className="text-xs text-neutral-500 font-medium italic">
                          All your data and portfolios will be permanently
                          erased. Please think twice.
                        </p>
                      </div>
                      <DashboardButton
                        variant="danger"
                        icon={Trash2}
                        className="h-14 px-8 shadow-xl shadow-red-500/10"
                      >
                        Delete Forever
                      </DashboardButton>
                    </div>
                      ...
                      {[
                        {
                          ...
                          desc: "Get a summary of your portfolio traffic once a month.",
                        },
                        {
                          id: "s",
                          label: "New Subscriber Alerts",
                          desc: "Instantly notify when someone signs up to your newsletter.",
                        },
                        {
                          id: "p",
                          label: "Product Updates",
                          desc: "Stay informed about new Profolio features and templates.",
                        },
                        {
                          id: "m",
                          label: "Marketing Tips",
                          desc: "Learn how to optimize your portfolio for better conversions.",
                        },
                      ].map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between py-4 border-b last:border-0 border-neutral-100 dark:border-white/5"
                        >
                          <div>
                            <p className="font-black text-sm tracking-tight italic">
                              {item.label}
                            </p>
            ...
            {activeTab === "billing" && (
              ...
              >
                <DashboardSection
                  title="Subscription"
                  description="Manage your current plan and usage limits."
                >
                  <DashboardCard className="bg-gradient-to-br from-indigo-500 to-indigo-700 text-white border-transparent relative overflow-hidden">
                    <div className="relative z-10">
                      ...
                      <p className="text-indigo-100 font-medium mb-10 max-w-sm italic">
                        You are currently using the free tier. Upgrade to unlock
                        custom domains and unlimited portfolios.
                      </p>
                      <DashboardButton
                        variant="secondary"
                        className="bg-white text-indigo-500 hover:bg-neutral-100 w-full md:w-auto h-14 px-10 shadow-2xl"
                      >
                        Upgrade Plan &rarr;
                      </DashboardButton>
                    </div>
