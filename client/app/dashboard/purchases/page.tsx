...
export default function PurchasesPage() {
  ...
  return (
    <div className="space-y-10">
      <PageHeader
        title="Purchases"
        description="View and manage your purchased items."
      />

      <DashboardSection
        title="Recent Purchases"
        description="Items you've bought from the marketplace"
      >
        {purchases.length === 0 ? (
          <EmptyState
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {purchases.map((purchase) => (
              <DashboardCard key={purchase.item_id}>
                {purchase.preview_images &&
                  purchase.preview_images.length > 0 && (
                ...
                <h3 className="text-lg font-black italic mb-2">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  >
                    {purchase.is_owner ? "Owner" : purchase.payment_status}
                  </span>
