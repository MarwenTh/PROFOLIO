...
export default function SEOPage() {
  ...
  if (!selectedPortfolio) {
    return (
      <EmptyState
        ...
        description="Create a portfolio first to manage SEO settings."
        icon={Globe}
      />
    );
  }
  ...
  return (
    <div className="space-y-10">
      <PageHeader
        title="SEO & Social"
        description={`Optimize ${selectedPortfolio.title} for search engines and social media.`}
      />

      <form onSubmit={handleSubmit} className="space-y-8">
        <DashboardSection
          title="Search Engine Optimization"
          description="Control how your portfolio appears in Google search results."
        >
          <DashboardCard>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-neutral-500 font-medium italic px-1">
              ...
              <DashboardInput
                ...
                placeholder="designer, developer, portfolio"
              ...
              <DashboardInput
                ...
                hint="Preferred URL for this portfolio"
              />
            </div>
          </DashboardCard>
        </DashboardSection>
        ...
        <DashboardSection
          ...
          description="Control how your portfolio appears when shared on social platforms."
        >
          <DashboardCard>
            <div className="space-y-6">
              <DashboardInput
