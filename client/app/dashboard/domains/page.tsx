...
export default function DomainsPage() {
  ...
  const { domains, loading, addDomain, deleteDomain, updateSlug } = useDomains(
  ...
  if (!selectedPortfolio) {
    return (
      <EmptyState
        ...
        description="Create a portfolio first to manage domains."
        icon={Globe}
      />
    );
  }
              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  {domains.map((domain) => (
                    <div
                      key={domain.id}
                      className="flex items-center justify-between p-3 rounded-xl bg-neutral-50 dark:bg-white/5 border border-neutral-200 dark:border-white/10"
                    >
        ...
        <div className="space-y-4">
          ...
          <ol className="space-y-3 text-sm text-neutral-600 dark:text-neutral-400 font-medium">
            ...
            <li className="flex gap-3">
              ...
              <span>
                Add your domain using the "Add Custom Domain" button above
              </span>
            </li>
            <li className="flex gap-3">
              ...
              <span>
                ...
                <code className="px-2 py-1 bg-neutral-100 dark:bg-neutral-800 rounded font-mono text-xs">
                  profolio.pro
                </code>
              </span>
            </li>
        ...
        >
          ...
          <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-start gap-3">
            ...
            <p className="text-xs font-medium text-amber-700 dark:text-amber-400">
              Changing your slug will break existing links to your portfolio.
              Make sure to update any shared URLs.
            </p>
          </div>
